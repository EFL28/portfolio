...
export const ui = {
  es: {
    ...
    "profileDescription.greeting": "Hola, soy Elián",
    "profileDescription.description": "Construyo sitios web y aplicaciones...",
    "profileDescription.currentFocus":
      "Fuera del trabajo, probablemente me encuentres explorando nuevas tecnologías o trabajando en proyectos paralelos. Si tienes un proyecto en mente, ¡no dudes en contactarme!",

    //___EXPERIENCE SECTION
    experience: "Experiencia laboral y formación",
    "experience.currently": "Actualmente...",

    // LMC: LetMeCharge
    "experience.LMC.title": "Desarrollador Backend",
  ...
  en: {
    ...
    //___PROFILE DESCRIPTION
    "profileDescription.greeting": "Hello, I'm Elián",
    "profileDescription.description":
      "I build websites and web applications across different industries, using amodular design approach to keep things simple and scalable.",
    "profileDescription.currentFocus":
      "Outside of work, you will probably find me exploring new technologies or working on side projects. If you have a project in mind, feel free to reach out!",
    ...
    // LMC: LetMeCharge
    "experience.LMC.title": "Backend Developer",
    "experience.LMC.company": "LetMeCharge",
  ...
  cat: {
    ...
    //___PROFILE DESCRIPTION
    "profileDescription.greeting": "Hola, sóc l'Elián",
    "profileDescription.description":
      "Construeixo llocs web i aplicacions web...",
    "profileDescription.currentFocus":
      "Fora de la feina, probablement em trobaràs explorant noves tecnologies o treballant en projectes paral·lels. Si tens un projecte en ment, no dubtis a contactar!",

    //___EXPERIENCE SECTION
    experience: "Experiència laboral i formació",
    "experience.currently": "Actualment...",

    // LMC: LetMeCharge
    "experience.LMC.title": "Desenvolupador Backend",
    "experience.LMC.company": "LetMeCharge",
